...
INSERT INTO `texts`(`meta_title`, `name`, `head` , `body`) VALUES('', 'О нас', 'Наша команда', 'Текст, который раскрывает суть нашего бытия и роль в этом мире.');
INSERT INTO `texts`(`meta_title`, `name`, `head` , `body`) VALUES('Lab Digital - Проекты - Ночь распродаж', 'Проект 1', 'Ночь распродаж' , '"Малый ГУМ: акция «Ночь распродаж»
...
INSERT INTO `texts`(`meta_title`, `name`, `head` , `body`) VALUES('Lab Digital - Проекты - Falck', 'Проект 2', 'Falck' , '"«Фальк Медикал Владивосток»: вывод бренда на рынок
...
INSERT INTO `texts`(`meta_title`, `name`, `head` , `body`) VALUES('Lab Digital - Проекты - Эстафета олимпийского огня', 'Проект 3', 'Эстафета олимпийского огня' , '"«Ингосстрах»: организация эстафеты олимпийского огня
